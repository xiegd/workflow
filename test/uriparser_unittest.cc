...
TEST(uriparser_unittest, parse) {
  ...
  EXPECT_EQ(URIParser::parse("https://john.doe:pass@www.example.com:123/forum/"
                             "questions/?tag=networking&order=newest#top",
                             uri),
            0);
  ...
  EXPECT_EQ(URIParser::parse("https://john.doe@www.example.com:123/forum/"
                             "questions/?tag=networking&order=newest#top",
                             uri),
            0);
  EXPECT_EQ(strcmp(uri.scheme, "https"), 0);
  ...
  EXPECT_EQ(URIParser::parse("ldap://[2001:db8::7]/c=GB?objectClass?one", uri),
            0);
  ...
  EXPECT_EQ(
      URIParser::parse("ldap://user@[2001:db8::7]/c=GB?objectClass?one", uri),
      0);
  EXPECT_EQ(strcmp(uri.scheme, "ldap"), 0);
  ...
  EXPECT_EQ(URIParser::parse(
                "ldap://user@[2001:db8::7]:12345/c=GB?objectClass?one", uri),
            0);
  EXPECT_EQ(strcmp(uri.scheme, "ldap"), 0);
  EXPECT_EQ(strcmp(uri.userinfo, "user"), 0);
  EXPECT_EQ(strcmp(uri.host, "2001:db8::7"), 0);
  ...
  EXPECT_EQ(
      URIParser::parse("ldap://[2001:db8::7]:12345/c=GB?objectClass?one", uri),
      0);
  EXPECT_EQ(strcmp(uri.scheme, "ldap"), 0);
  EXPECT_EQ(uri.userinfo, nullptr);
  EXPECT_EQ(strcmp(uri.host, "2001:db8::7"), 0);
  ...
  EXPECT_EQ(uri.host, nullptr);
  EXPECT_EQ(uri.port, nullptr);
  EXPECT_EQ(strcmp(uri.path, "oasis:names:specification:docbook:dtd:xml:4.1.2"),
            0);
  EXPECT_EQ(uri.query, nullptr);
  EXPECT_EQ(uri.fragment, nullptr);

  EXPECT_EQ(URIParser::parse("https://www.example.com:123/forum/questions/"
  ...
  EXPECT_EQ(URIParser::parse("https://john.doe@www.example.com/forum/questions/"
                             "?tag=networking&order=newest#top",
                             uri),
            0);
  EXPECT_EQ(strcmp(uri.scheme, "https"), 0);
  ...
  EXPECT_EQ(
      URIParser::parse(
          "http://www.test.cn/subject/ttt/index.html?abc-def-jki-lm-rstuvwxyz",
          uri),
      0);
  ...
  EXPECT_EQ(URIParser::parse("http://sg.test1.com/zt/zz/#这是中文测试", uri),
            0);
  EXPECT_EQ(strcmp(uri.scheme, "http"), 0);
  EXPECT_EQ(uri.userinfo, nullptr);
  ...
  EXPECT_EQ(URIParser::parse("http://"
                             "www.test2.com?sg_vid=R_3qHh9H471Ry8OtW5J9R10vc_"
                             "QR6EQqgA6HHLO6666666qe0Co66666666",
                             uri),
            0);
  EXPECT_EQ(strcmp(uri.scheme, "http"), 0);
  EXPECT_EQ(uri.userinfo, nullptr);
  ...
  EXPECT_EQ(
      strcmp(
          uri.query,
          "sg_vid=R_3qHh9H471Ry8OtW5J9R10vc_QR6EQqgA6HHLO6666666qe0Co66666666"),
      0);
  EXPECT_EQ(uri.fragment, nullptr);

  EXPECT_EQ(
      URIParser::parse("https://sgsares.test3.com/ttts/中文测试_4115.apk", uri),
      0);
  EXPECT_EQ(strcmp(uri.scheme, "https"), 0);
  EXPECT_EQ(uri.userinfo, nullptr);
  ...
  EXPECT_EQ(URIParser::parse(
                "http://"
                "viptest.test5.com:8484?sg_vid="
                "Rucnk5BKG81RcIVk7XySNhQtBODR6mKXA06PpWA66666663MTAfR6666666",
                uri),
            0);
  EXPECT_EQ(strcmp(uri.scheme, "http"), 0);
  EXPECT_EQ(uri.userinfo, nullptr);
  ...
  EXPECT_EQ(
      strcmp(
          uri.query,
          "sg_vid=Rucnk5BKG81RcIVk7XySNhQtBODR6mKXA06PpWA66666663MTAfR6666666"),
      0);
  EXPECT_EQ(uri.fragment, nullptr);
