...
/**
 * @brief      S=P>P
 * @note       Equivalent to Workflow::create_series_work(&x,
 * nullptr)->push_back(&y)
 */
...
/**
 * @brief      P=P*t
 * @note       Equivalent to x.add_series(Workflow::create_series_work(&y,
 * nullptr))
 */
...
/**
 * @brief      P=t*P
 * @note       Equivalent to y.add_series(Workflow::create_series_work(&x,
 * nullptr))
 */
...
/**
 * @brief      P=S*S
 * @note       Equivalent to Workflow::create_parallel_work({&x, &y}, 2,
 * nullptr)
 */
...
/**
 * @brief      P=S*t
 * @note       Equivalent to Workflow::create_parallel_work({&y}, 1,
 * nullptr)->add_series(&x)
 */
...
/**
 * @brief      P=t*S
 * @note       Equivalent to Workflow::create_parallel_work({&x}, 1,
 * nullptr)->add_series(&y)
 */
 ...
 * @brief      P=t*t
 * @note       Equivalent to
 * Workflow::create_parallel_work({Workflow::create_series_work(&x, nullptr),
 * Workflow::create_series_work(&y, nullptr)}, 2, nullptr)
 */
 ...
 */
static inline ParallelWork &operator*(SubTask *x, SubTask &y);
// static inline ParallelWork& operator*(SubTask *x, SubTask *y);//compile
// error!
...
static inline SeriesWork &operator>(SubTask &x, SubTask *y) { return x > *y; }
static inline SeriesWork &operator>(SubTask *x, SubTask &y) { return *x > y; }
// S=S>P
static inline SeriesWork &operator>(SeriesWork &x, ParallelWork &y) {
  return x > (SubTask &)y;
