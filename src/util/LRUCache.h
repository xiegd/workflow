...
template <typename KEY, typename VALUE> class LRUHandle {
public:
  VALUE value;
...
template <typename KEY, typename VALUE, class ValueDeleter> class LRUCache {
protected:
...
public:
  ...
  void set_max_size(size_t max_size) { this->max_size = max_size; }
