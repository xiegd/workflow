...
public:
  WFSGResolverTask(const struct WFNSParams *params, WFServiceGovernance *sg,
...
WFRouterTask *
WFServiceGovernance::create_router_task(const struct WFNSParams *params,
...
void WFServiceGovernance::add_server(const std::string &address,
  ...
  EndpointAddress *addr =
      new EndpointAddress(address, new PolicyAddrParams(params));
...
void WFServiceGovernance::get_current_address(
