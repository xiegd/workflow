...
void mysql_parser_get_info(const char **info_str, size_t *info_len,
...
static inline void
mysql_result_set_cursor_init(mysql_result_set_cursor_t *cursor,
                             mysql_parser_t *parser) {
...
static inline void
mysql_result_set_cursor_rewind(mysql_result_set_cursor_t *cursor) {
  cursor->current = cursor->head;
}

static inline void
mysql_result_set_cursor_deinit(mysql_result_set_cursor_t *cursor) {}

static inline int
mysql_result_set_cursor_next(struct __mysql_result_set **result_set,
