...
public:
  ...
  // set success times before passing, refer to success_before_passing,
  // default:0
  ...
  // set failure times before critical, refer to failures_before_critical,
  // default:0
  void set_failure_times(int times) {
    this->ptr->check_cfg.failure_times = times;
  }
