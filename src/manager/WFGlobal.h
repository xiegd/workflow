...
public:
  ...
  static class RouteManager *get_route_manager() { return &route_manager_; }

  static class DnsCache *get_dns_cache() { return &dns_cache_; }

  static class WFDnsResolver *get_dns_resolver() { return &dns_resolver_; }

  static class WFNameService *get_name_service() { return &name_service_; }
